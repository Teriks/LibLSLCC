...
public partial class LSLParser : Parser {
	...
	public partial class Expr_AssignmentContext : ExpressionContext {
		public ModifiableLeftValueContext expr_mod_lvalue;
		public IToken operation;
		public ExpressionContext expr_rvalue;
		public ModifiableLeftValueContext modifiableLeftValue() {
	...
	private ExpressionContext expression(int _p) {
		...
		try {
			...
			case 1:
				...
				State = 224; ((ParenthesizedExpressionContext)_localctx).open_parenth = Match(O_PAREN);
				State = 225; ((ParenthesizedExpressionContext)_localctx).expr_value = expression(0);
				State = 226; ((ParenthesizedExpressionContext)_localctx).close_parenth = Match(C_PAREN);
				}
				break;
			case 2:
				{
				...
				Context = _localctx;
				_prevctx = _localctx;
				State = 228; ((Expr_FunctionCallContext)_localctx).function_name = Match(ID);
				{
				State = 229; ((Expr_FunctionCallContext)_localctx).open_parenth = Match(O_PAREN);
				State = 230; ((Expr_FunctionCallContext)_localctx).expression_list = optionalExpressionList();
				State = 231; ((Expr_FunctionCallContext)_localctx).close_parenth = Match(C_PAREN);
				}
				}
				break;
			case 3:
			...
			case 4:
				...
				State = 235; ((Expr_PrefixOperationContext)_localctx).expr_rvalue = expression(14);
				}
				break;
			case 5:
				{
				...
				_prevctx = _localctx;
				{
				State = 236; ((Expr_TypeCastContext)_localctx).open_parenth = Match(O_PAREN);
				State = 237; ((Expr_TypeCastContext)_localctx).cast_type = Match(TYPE);
				State = 238; ((Expr_TypeCastContext)_localctx).close_parenth = Match(C_PAREN);
				}
				State = 240; ((Expr_TypeCastContext)_localctx).expr_rvalue = expression(13);
				}
				break;
			case 6:
				{
				...
				Context = _localctx;
				_prevctx = _localctx;
				State = 241; ((Expr_ModifyingAssignmentContext)_localctx).expr_mod_lvalue = modifiableLeftValue();
				State = 242;
				...
				State = 243; ((Expr_ModifyingAssignmentContext)_localctx).expr_rvalue = expression(3);
				}
				break;
			case 7:
				{
				...
				Context = _localctx;
				_prevctx = _localctx;
				State = 245; ((Expr_AssignmentContext)_localctx).expr_mod_lvalue = modifiableLeftValue();
				State = 246; ((Expr_AssignmentContext)_localctx).operation = Match(EQUAL);
				State = 247; ((Expr_AssignmentContext)_localctx).expr_rvalue = expression(2);
				}
				break;
			case 8:
				{
	...
	private static string _serializeATN()
	{
		...
		sb.Append("\x2\x2\xE1\xE2\b\x18\x1\x2\xE2\xE3\a+\x2\x2\xE3\xE4\x5.\x18");
		sb.Append("\x2\xE4\xE5\a,\x2\x2\xE5\x106\x3\x2\x2\x2\xE6\xE7\a\r\x2\x2");
		sb.Append("\xE7\xE8\a+\x2\x2\xE8\xE9\x5\x30\x19\x2\xE9\xEA\a,\x2\x2\xEA");
		sb.Append("\x106\x3\x2\x2\x2\xEB\x106\x5*\x16\x2\xEC\xED\t\x3\x2\x2\xED");
		sb.Append("\x106\x5.\x18\x10\xEE\xEF\a+\x2\x2\xEF\xF0\a\x3\x2\x2\xF0\xF1");
		sb.Append("\a,\x2\x2\xF1\xF2\x3\x2\x2\x2\xF2\x106\x5.\x18\xF\xF3\xF4\x5");
		sb.Append(",\x17\x2\xF4\xF5\t\x4\x2\x2\xF5\xF6\x5.\x18\x5\xF6\x106\x3\x2");
		sb.Append("\x2\x2\xF7\xF8\x5,\x17\x2\xF8\xF9\a\x13\x2\x2\xF9\xFA\x5.\x18");
		sb.Append("\x4\xFA\x106\x3\x2\x2\x2\xFB\x104\a\r\x2\x2\xFC\x104\a\x11\x2");
		...
		sb.Append("\x104\x106\x3\x2\x2\x2\x105\xE1\x3\x2\x2\x2\x105\xE6\x3\x2\x2");
		sb.Append("\x2\x105\xEB\x3\x2\x2\x2\x105\xEC\x3\x2\x2\x2\x105\xEE\x3\x2");
		sb.Append("\x2\x2\x105\xF3\x3\x2\x2\x2\x105\xF7\x3\x2\x2\x2\x105\x103\x3");
