    ...
    def __init__(self):
        if self._ON_WINDOWS:
            ...
            if not os.path.isfile(self._MSBUILD):
                ...
                raise Exception("MSBuild 12.0 Standalone: https://www.microsoft.com/en-us/download/details.aspx?id=40760")
                raise Exception("MSBuild 14.0 Standalone: https://www.microsoft.com/en-in/download/details.aspx?id=48159")
        else:
